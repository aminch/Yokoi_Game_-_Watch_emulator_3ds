...
class HockeyGameProcessor(GameProcessor):
	def __init__(self, target_name: str = "3ds"):
		super().__init__(target_name)

		# Specifics for Hockey (Elektronika)
		self.game_key = "Hockey_Elektronika" # Key from games_path.py
		self.game_folder = "ehockey" # Folder name for the game
