...
class SpaceAdventureGameProcessor(GameProcessor):
	def __init__(self, target_name: str = "3ds"):
		super().__init__(target_name)

		# Specifics for Space Adventure
		self.game_key = "Space_Adventure" # Key from games_path.py
		self.game_folder = "trspacadv" # Folder name for the game
